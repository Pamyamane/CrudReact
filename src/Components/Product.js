...
const Product = () => {
    ...
    const LoadUsers = async () => {
        const Result = await axios.get("http://localhost:3003/users1");
    ...
    const onClickDelete = async (id) => {
        ...
        if (userConfirmed) {
          try {
            await axios.delete(`http://localhost:3003/users1/${id}`);
            ...
            <Grid container spacing={1}>
                ...
                <Grid item xs={11}>
                    <Paper>
                        <div >
                            <div>
                               <h2><AllInboxSharpIcon /> Product</h2>
                                    ...
                                    <tbody style={{ justifyContent: "center", alignItems: "center",}}>
                                        {record.map((user, index) => (
                                            <tr style={{ justifyContent: "center", alignItems: "center",}}>
                                                ...
                                                <td><Link to={`/EditProduct/${user.id}`}><EditIcon /></Link></td>
